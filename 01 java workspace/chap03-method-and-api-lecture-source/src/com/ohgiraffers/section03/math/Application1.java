...
public class Application1 {
    public static void main(String[] args) {
        ...
        //1. 절대 값 출력
        //풀글래스 이름 작성
        System.out.println("-7의 절대값 : " + (java.lang.Math.abs(-7))); //.abs 전달받은 값을 절대값으로 바꿔 반환

        //import 해서 작성
        //java.lang 패키지 하위의 기능은 매우 자주 사용 되는 기능들이기 때문에 컴파일러가 자동으로 import java.lang.*;
        // 코드를 추가한다. 따라서 별도의 import가 필요 없다.
        ...
        //4.난수 출력 (난수 = 랜덤값) 호출 시 마다 다른 값을 가짐
        //0부터 1 미만의 실수 형태의 난수를 발생시킴
