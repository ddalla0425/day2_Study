...
public class Application1 {
    public static void main(String[] args) {
        //ArrayList
        //ArrrayList는 배열의 단점을 보완하기 위해 만들어 졌다.
        ...
        //toString() 메소드가 오버라이딩 되어 있어 담겨있는 요소들을 확인 할 수 있다.
        ...
        //지정 된 위치의 값을 수정할 때도 인덱스를 활용하여 ser() 메소드를 사용한다.
        alist.set(1, true);
        System.out.println("alist : " + alist);
        ...
        //제네릭 타입을 지정하면 타입 외의 인스턴스는 저장하지 못함
        //stringList.add(123);
