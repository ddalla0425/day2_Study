...
public class A_for {
    public void testSimpleForStatement() {
        ...
        //1부터10까지 1씩 증가시키면서(10번) 값을 출력하는 반복문
        int num = 10;
        for (int i = 1; i <= num; i++) {
    ...
    public void testForExample1() {
        //무엇을 반복해야 하는지 확인 한뒤 반목문으로 코드 개선하기
        ...
        //위의 10번씩 받복해서 써야할 코드를 반복문으로 한번만 쓸 수 있게 개선함
        for (int i = 1; i <= 10; i++) {
    ...
    public void testForExample2() {
        ...
        //결과를 누적시켜 담아줄 변수 선언
        //더한 값을 누적시킬 수 변수는 통상적으로 0으로 초기화
        int sum = 0;
    ...
    public void testForExample4() {
        //숫자 2개를 입력 받아 작은 수에어 큰 수까지의 합계를 구하시요.
