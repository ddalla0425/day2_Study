...
public class Application2 {
    public static void main(String[] args) {
        ...
        int salesRevenue = sc.nextInt();

        //보너스 변수 선언 초기화
        double bonus = 0;

        if(salesRevenue >= 50000000) {
            bonus = 5;
        }else if(salesRevenue >= 30000000) {
            bonus = 3;
        }else if(salesRevenue >= 10000000) {
            bonus = 1;
        }else {
            bonus = 0;
        }
        ...
        //총급여 계산식
        int sumSalary = monthlySalary + (int)(salesRevenue * (bonus / 100));

        System.out.println("====================");
        System.out.println("매출액 : " + salesRevenue);
        System.out.println("보너스율 : " + (int)bonus + "%");
        System.out.println("월급여 : " + monthlySalary);
        System.out.println("보너스 금액 : " + (int)(salesRevenue * (bonus / 100)));
        System.out.println("====================");
        System.out.println("총 급여 : " + sumSalary);
