...
//------------------------------------------
    ...
    //생성자의 사용 목적  >>필드값을 초기화 한다는게 생성자의 주된 목적
    ...
    // 매개변수부가 다르면 생성자를 여러개 생성할 수 있다.

    //1. 기본 생성자(default constructor)
    // 클래스 내애 작성 된 생성자가 0개일 경우 컴파일러가 자동으로 기본 생성자를 생성한다. (그래서 여지껏 생성자를 만들지 않고 쓸 수 있었다)
    public User() {  //반환형이 없고 이름은 클래스명과 동일해야 한다.
        //인스턴스 생성 시점에 수행할 명령이 있는 경우 작성할 수 있다.
        System.out.println("User 클래스의 기본 생성자 호출함...");
    }

    //2. 매개변수 생성자
    //초기화 할 필드가 여러 개인 경우, 초기화 하고 싶은 필드의 조합 별로 생성자를 여러 개 작성 할 수 있다.
...
//        this.name = name;
        ...
        this(id, pwd, name);//반드시 첫번째 줄에 작성 되야함
...
//------------------------------------------
    //메소드 선언부
    //[자동완성 설정] Alt + Insert 누르고 shift + 아래화살표  다 선택후 ok
