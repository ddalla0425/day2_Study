...
public class Application2 {
    public static void main(String[] args) {
        ...
        System.out.println("str3 == str4 : " + (str4 == str4));

        //동일한 문자열은 동일한 hashCode 값을 반환하도록 String 클래스에 재정의 되어 있다.
        System.out.println("str1.hashConde() : " + str1.hashCode());
        System.out.println("str2.hashConde() : " + str2.hashCode());
        System.out.println("str3.hashConde() : " + str3.hashCode());
        System.out.println("str4.hashConde() : " + str4.hashCode());
        ...
        System.out.println("str4.equals(str3) : " + str4.equals(str4));
